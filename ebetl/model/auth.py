...
class Group(DeclarativeBase):
    ...
    group_id = Column(Integer, Sequence('contagroup'),autoincrement=True, primary_key=True)
...
class User(DeclarativeBase):
    ...
    user_id = Column(Integer, Sequence('contauser'), autoincrement=True, primary_key=True)
...
class Permission(DeclarativeBase):
    ...
    permission_id = Column(Integer, Sequence('contapermission'),autoincrement=True, primary_key=True)
